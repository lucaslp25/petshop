...
public class AgendamentoDaoJDBC implements AgendamentoDao {
    ...
    @Override
    public List<Agendamento> findByFuncionario(Funcionario funcionarioResponsavel) {
        ...
        try{
            ...
            st.setInt(1, funcionarioResponsavel.getId());
    ...
    @Override
    public List<Agendamento> findByClienteCpf(String cpf) {
    ...
    @Override
    public List<Agendamento> findByMonthAndYear(Integer month, Integer year) {
        ...
        try{
            String sql = "SELECT " +
                    ...
                    "INNER JOIN " +
                    "cliente c ON pet.cliente_id = c.id " +
                    "WHERE MONTH(a.data_hora) = ? AND YEAR(a.data_hora) = ?";
